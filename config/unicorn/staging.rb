...
listen '/tmp/staging.equitabletod.socket', backlog: 64
listen 8013
...
pid '/tmp/unicorn.equitabletod.pid'

# Production-specific settings
if env == 'production'
  # Help ensure your application will always spawn in the
  # symlinked 'current' directory that Capistrano sets up
  working_directory '/home/deployer/apps/staging.equitabletod/current'

  # feel free to point this anywhere accessible on the filesystem
  user 'deployer', 'staff'
  shared_path = '/home/deployer/apps/staging.equitabletod/shared'
...
before_fork do |server, worker|
  ...
  old_pid = '/tmp/unicorn.equitabletod.pid.oldbin'
